...
using BulletinBoard.UserService.AppServices.User.User.Commands.Register.Helpers;

namespace BulletinBoard.UserService.tests.ApplicationTests.UserTests.User.CommandsTests.RegisterTests.HelpersTests;
