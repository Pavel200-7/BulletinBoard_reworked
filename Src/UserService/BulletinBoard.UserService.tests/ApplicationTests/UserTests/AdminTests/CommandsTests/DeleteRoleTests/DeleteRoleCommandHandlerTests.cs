...
using BulletinBoard.UserService.AppServices.User.Admin.Commands.DeleteRole;
...
namespace BulletinBoard.UserService.tests.ApplicationTests.UserTests.AdminTests.CommandsTests.DeleteRoleTests;
